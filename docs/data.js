        ...
        social: [
            {
                name: "food",
                level: 57,
                indicator: "% of adults who are food secure",
                value: "43%",
                year: 2024,
                target: "100%",
                context: "Only 43% of low-income adults (below 200% FPL) are food secure, exposing a deep 57% structural shortfall across vulnerable neighborhoods.",
                source: "SF Dept. of Public Health (BFSER)",
                sourceUrl: "https://www.sf.gov/information--biennial-food-security-and-equity-report",
                screenshot: null,
                actions: ["Expand healthy retail grocery initiatives and reinforce local edible food recovery networks."]
            },
            {
                name: "health",
                level: 32,
