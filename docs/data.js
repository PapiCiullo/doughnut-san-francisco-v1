        ...
        ecological: [
            {
                name: "climate change",
                level: 76,
                indicator: "tCO₂e per capita",
                value: "4.40",
                year: 2024,
                target: "2.5",
                context: "~4.4 metric tons CO2e per capita tracks over the science-based target thresholds.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Reduce greenhouse gas emissions footprint."]
            },
            {
                name: "ocean acidification",
                level: 0,
            ...
            },
            {
                name: "nitrogen & phosphorus loading",
                level: 66,
                indicator: "% Over Ecological Ceiling",
                value: "66.0%",
                year: 2024,
                target: "0.0%",
                context: "66% Overshoot (Current load of 17.3 tons/day vs. the 2035 'Safe Limit' of ~10.4 tons/day for SF's share of the Bayside aggregate).",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Minimize industrial nutrient discharge fields."]
            },
            {
                name: "freshwater withdrawals",
                level: 0,
                indicator: "Per capita freshwater use / withdrawals",
                value: "43 GPCD (Residential)",
                year: 2024,
                target: "Sustainable system caps",
                context: "San Francisco is often cited as a global leader in water efficiency. 43 Gallons Per Capita per Day (GPCD) (Residential) as of FY 2024-2025.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Maintain household water efficiencies."]
            },
            {
                name: "land conversion",
                level: 50,
                indicator: "% Impermeable",
                value: "60.0%",
                year: 2024,
                target: "40.0%",
                context: "~31.4% of land is currently under 'Protective Management'. 60% Impermeable Surface Coverage represents a notable soil sealing layer overshoot.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Support permeable green space configurations."]
            },
            {
                name: "biodiversity loss",
                level: 69,
                indicator: "% Non-Biodiverse Urban Cover",
                value: "69.0%",
                year: 2024,
                target: "0.0%",
                context: "45% of key indicator species are stable, while 55% remain in decline or 'Poor' condition (Source: 2025 State of Our Estuary Report). Total urban pavement landscape drives habitat reduction thresholds.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Incorporate native plant corridors in local architecture."]
            },
            {
                name: "air pollution",
                level: 44,
                indicator: "mcg/m3 per capita exposure",
                value: "7.20 mcg/m3",
                year: 2024,
                target: "5.0",
                context: "Annual Mean PM2.5 = 7.2 mcg/m3 (2023). San Francisco operates at 144% of the WHO healthy air guideline.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Reduce industrial emission spikes."]
            },
            {
                name: "ozone layer depletion",
                level: 0,
        ...
        social: [
            {
                name: "food",
                level: 57,
                indicator: "% of adults (below 200% FPL) who are food secure",
                value: "43.0%",
                year: 2024,
                target: "100.0%",
                context: "67% of San Francisco adults below 200% of the federal poverty level are food insecure.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Support regional food security programs."]
            },
            {
                name: "health",
                level: 32,
                ...
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Support local health accessibility maps."]
            },
            {
                name: "education",
                level: 23,
                ...
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Engage with literacy and youth programs."]
            },
            {
                name: "income & work",
                level: 27,
                ...
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Support local minimum wage standard reviews."]
            },
            {
                name: "housing",
                level: 38,
                ...
                year: 2024,
                target: "100.0%",
                context: "38.4% of renter households in San Francisco are 'rent-burdened,' spending more than 30% of their gross income on housing.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Support local affordable housing production."]
            },
            {
                name: "water & sanitation",
                level: 15,
                ...
                year: 2024,
                target: "100.0%",
                context: "85% of households meet the 'safe and affordable' foundation, leaving a 15% shortfall driven by the high cost of utility bills.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Support municipal utility baseline breaks."]
            },
            {
                name: "energy",
                level: 11,
                ...
                year: 2024,
                target: "100.0%",
                context: "11.2% of San Francisco households are 'energy burdened,' spending more than 6% of their gross income on home energy bills.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Inquire about clean energy retrofits."]
            },
            {
                name: "social equity",
                level: 39,
                ...
                year: 2024,
                target: "100.0%",
                context: "68% of residents report having a friend or family member they can rely on for support. 61% report feeling systematically respected and included.",
                source: "U.S. Census Bureau ACS / Municipal Reports",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Engage with neighborhood community organizations."]
            },
            {
                name: "peace & justice",
                level: 17,
                indicator: "Inverse Violent Crime Rate",
                value: "83.0%",
                year: 2024,
                target: "100.0%",
                context: "52% of San Francisco residents report feeling 'safe' or 'very safe' walking alone in their neighborhood after dark.",
                source: "San Francisco City Data Portals",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Review safety and civic trust indexes."]
            },
            {
                name: "political voice",
                level: 44,
            ...
            },
            {
                ...
                year: 2024,
                target: "1.0",
                context: "Women working full-time, year-round in San Francisco earn approximately 87 cents for every $1 earned by men.",
                source: "California Bureau of Labor Statistics",
                sourceUrl: "https://www.bls.gov",
                screenshot: null,
                actions: ["Support transparent payroll audits."]
            },
            {
                name: "networks",
                level: 48,
                ...
                year: 2024,
                target: "100.0%",
                context: "52% of work trips are made by public transport, walking, or cycling. 89.1% of households maintain operational broadband connectivity.",
                source: "U.S. Census Bureau ACS / Municipal Reports",
                sourceUrl: "https://data.sfgov.org",
                screenshot: null,
                actions: ["Use green transit alternatives."]
            }
        ]
    }
};
